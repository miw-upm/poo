...
public class Article {
    ...
    public static ArticleBuilders.Barcode builder() {
        return new Builder();
    }
    ...
    public static class Builder implements ArticleBuilders.Barcode, ArticleBuilders.Summary, ArticleBuilders.Price, ArticleBuilders.Optionals {
        ...
        public ArticleBuilders.Summary barcode(String barcode) {
            this.article.setBarcode(barcode);
            return this;
        }

        public ArticleBuilders.Price summary(String summary) {
            this.article.summary = summary;
            return this;
        }

        public ArticleBuilders.Optionals price(BigDecimal price) {
            this.article.price = price;
            return this;
        }

        public ArticleBuilders.Optionals provider(String provider) {
