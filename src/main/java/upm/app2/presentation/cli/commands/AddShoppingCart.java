...
public class AddShoppingCart implements Command {
    ...
    public AddShoppingCart(View view, ShoppingCartService cartService) {
        this.view = view;
    ...
    public List<String> params() {
        return List.of("id", "articleId", "amount", "discount");
    }

    @Override
    public String helpMessage() {
        return "Se añade un artículo al carro existente";
    }
